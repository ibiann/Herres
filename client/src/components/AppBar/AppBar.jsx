...
import { MenuOutlined, HomeOutlined, SolutionOutlined, SearchOutlined, ScheduleOutlined, BellOutlined, ThunderboltOutlined } from "@ant-design/icons";
        ...
        <Row>
          <Col xs={6} md={4} className='col-no-padding'>
            <div className="action-apps">
              <div className="items-left all"><MenuOutlined /></div>
              <div className="items-left home"><HomeOutlined /></div>
              <div className="items-left boards"><SolutionOutlined />&nbsp;&nbsp;<strong>Boards</strong></div>
          ...
          <Col xs={6} md={4} className="col-no-padding">
            <div className="app-branding text">
              <a href="www.google.com" target="blank">
                <img src="https://picsum.photos/200/200" className="logo-top" alt="merres-logo" />
          ...
          <Col xs={6} md={4} className="col-no-padding">
            <div className="user-action">
              <div className="items-right quick"><ScheduleOutlined /></div>
              <div className="items-right news"><ThunderboltOutlined /></div>
              <div className="items-right notification"><BellOutlined /></div>
